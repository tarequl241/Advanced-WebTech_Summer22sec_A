...
<body>
    ...
    <style>
		...
		<td align="center"><font face="Lucida Sans Unicode" color="White"><a href="{{route('product.list')}}"><b><p style="font-size:18px">Products</p></b></a> </font></td>
    <td align="center"><font face="Lucida Sans Unicode" color="White"><a href=a href="{{route('product.create')}}"><b><p style="font-size:18px">Products Create</p></b></a> </font></td>
